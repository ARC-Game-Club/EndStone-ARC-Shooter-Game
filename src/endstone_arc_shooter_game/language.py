...
DEFAULT_TEXTS = {
    ...
    "START_BROADCAST": "§a§l[比赛] §r§a比赛即将开始！请准备传送。\n§e购买时间 §l{0}§r§e 秒。§6右键弧光币§e打开商店。",
    "COUNTDOWN_CANCELLED": "§e§l[比赛] §r§e人数不足，开赛倒计时已取消。",
    "TITLE_COUNTDOWN": "§e§l{0}",
    "TITLE_COUNTDOWN_SUB": "§7即将传送到战场",
    "TITLE_BUY": "§e§l购买阶段",
    "TITLE_BUY_SUB": "§f剩余 §l{0}§r§f 秒 · 右键弧光币打开商店",
    "TITLE_BATTLE": "§c§l战斗开始！",
    "TITLE_BATTLE_SUB": "§f限时 §l{0}§r§f 分钟 · 先达到 §l{1}§r§f 分获胜",
    "TITLE_MATCH_END_COUNT": "§c§l{0}",
    "TITLE_MATCH_END_COUNT_SUB": "§e比赛即将结束",
    ...
    "MATCH_WARN_ONE_MINUTE": "§6§l[比赛] §r§e比赛还有 §l1§r§e 分钟结束！",
    "MATCH_WARN_SECONDS": "§6§l[比赛] §r§e比赛还有 §l{0}§r§e 秒结束！",
    "MATCH_END_TIME": "§6§l[比赛] §r§e时间到！比赛结束。",
    "MATCH_RESULT_TOAST_TITLE": "比赛结束",
    "MATCH_RESULT_TOAST_WIN": "§a胜利！§r {0} §7{1} - {2} §7{3}",
    "MATCH_RESULT_TOAST_LOSE": "§c惜败§r {0} §7{1} - {2} §7{3}",
    "MATCH_RESULT_TOAST_DRAW": "§e平局§r {0} §7{1} - {2} §7{3}",
    "ASSIGN_TITLE": "调整分队",
    ...
    "MATCH_END_TIME_NOTE": "§f时间到！",
    "MATCH_END_SCORE": "{0} §7{1} - {2} §7{3}",
    "MATCH_END_WINNER": "§f获胜：{0}",
    "MATCH_END_DRAW": "§f本局没有获胜队伍。",
    "MATCH_END_STATS_TEAM": "§f§l{0}",
    "MATCH_END_STATS_PLAYER": "{0}§f：击杀{1} 死亡{2}",
    "MATCH_END_REWARDS_HEADER": "§f§l赛后奖励",
    "MATCH_END_REWARD_MONEY": "{0}§f：金钱 +{1}",
    "MATCH_END_REWARD_CONTRIB": "{0}§f：公会贡献 +{1}",
    "MATCH_END_REWARD_BOTH": "{0}§f：金钱 +{1} | 公会贡献 +{2}",
    "MATCH_END_REWARD_NONE": "{0}§f：无奖励（K-D ≤ 0）",
    "MATCH_END_FOOTER": "§6==============================",
