...
DEFAULT_TEXTS = {
    "MENU_TITLE": "射击游戏",
    "MENU_CONTENT": "选择大厅、查看个人信息或配置地图。",
    "BTN_LOBBY_LIST": "大厅列表",
    "BTN_PROFILE": "个人信息",
    "BTN_CONFIG_MAPS": "配置地图",
    "PROFILE_TITLE": "个人信息 · {0}",
    "PROFILE_LINE_KD": "§f生涯击杀 §a{0}§f / 死亡 §c{1}§f · KD §e{2}",
    "PROFILE_LINE_MATCHES": "§f场次 §e{0}§f · 胜场 §a{1}§f · MVP §6{2}",
    "PROFILE_LINE_TITLE": "§f当前头衔：{0}[{1}] {2}",
    "PROFILE_WEAPON_HEADER": "§e武器击杀排行",
    "PROFILE_WEAPON_LINE": "§7· §f{0} §7× §a{1}",
    "PROFILE_WEAPON_EMPTY": "§7暂无武器击杀记录。",
    "PROFILE_UNAVAILABLE": "§c生涯数据暂不可用。",
    ...
    "CREATE_LOBBY_FULL": "§c大厅已满：当前 {0}/{1}（大厅数不能超过可玩地图数）。",
    "CREATE_LOBBY_NO_MAPS": "§c当前没有可玩地图，无法创建大厅。请先让 OP 配置地图。",
    ...
    "JOIN_OK_ADMIN": "§a§l[大厅] §r§a你已创建大厅并成为房主。\n§e默认随机地图与模式，开局时自动分配空余地图。\n§e请在 15 分钟内开始，否则大厅将自动解散。",
    ...
    "START_NO_FREE_MAP": "§c当前没有空余可玩地图，请稍后再试。",
    "START_MAP_ASSIGNED": "§a§l[比赛] §r§a本局地图：§e{0}§a · 模式：§e{1}",
    "START_BROADCAST": "§a§l[比赛] §r§a比赛即将开始！请准备传送。\n§e购买时间 §l{0}§r§e 秒。§6右键弧光币§e打开商店。",
    "START_BROADCAST_NO_BUY": "§a§l[比赛] §r§a比赛即将开始！请准备传送。\n§e本模式不使用购买阶段，将直接开赛并发放武器。",
    "SHOP_DISABLED_MODE": "§e当前模式不使用武器商店。",
    ...
    "KILL_TOAST_TITLE": "击杀",
    "KILL_TOAST_CONTENT": "§a淘汰了 §e{0}",
    "ASSIST_CREDIT": "§e助攻 §7（参与击杀 §f{0}§7）",
    "BTN_SHOP": "打开商店",
    ...
    "SHOP_ITEM_UPGRADE": "{0} §7-§r 补差价 §e{1}§r点 §8(原价 {2})§r{3}",
    "SHOP_OWNED": " §a(已持有)",
    "SHOP_EMPTY": "该分类暂无武器，请编辑 weapons.json。",
    "BUY_OK": "§a购买 {0}，剩余点数 {1}。",
    "BUY_OK_UPGRADE": "§a升级为 {0}（补差价 {1}），剩余点数 {2}。",
    "BUY_FAIL_POINTS": "§c点数不足。需要 {0}，当前 {1}。",
    "BUY_FAIL_UNKNOWN": "§c未知武器。",
    "BUY_ALREADY_OWNED": "§e你已拥有 {0}。",
    ...
    "MAP_SELECT_RANDOM_OK": "§a已设为随机地图与模式；开局时自动分配空余地图。",
    "MAP_SELECT_BUSY": "§c该地图正被其他大厅使用。",
    "MAP_SELECT_TAKEN": "§c地图「{0}」已被其他大厅抢先占用，请重新选择。",
